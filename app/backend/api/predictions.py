...
async def get_predictions_dashboard(
    ...
    if total_flights == 0:
        return PredictionsDashboardResponse(
            kpi_cards=[
                ...
                KPICard(label="Cancels", value="0", color="slate"),
                KPICard(label="Diversions", value="0", color="slate"),
                KPICard(label="Peak", value="0", color="slate"),
    ...
    kpi_cards = [
        ...
        KPICard(label="Cancels", value="0", color="slate"),
        KPICard(label="Diversions", value="0", color="slate"),
        KPICard(label="Peak", value=str(total_flights), color="blue"),
