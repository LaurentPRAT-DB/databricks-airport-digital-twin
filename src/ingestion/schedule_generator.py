...
AIRLINES = {
    ...
    "NKS": {"name": "Spirit Airlines", "weight": 0.04, "hubs": ["FLL", "LAS", "MCO"]},
    "FFT": {"name": "Frontier Airlines", "weight": 0.04, "hubs": ["DEN", "LAS", "MCO"]},
    "HAL": {"name": "Hawaiian Airlines", "weight": 0.02, "hubs": ["HNL"]},
    "AAY": {"name": "Allegiant Air", "weight": 0.02, "hubs": ["LAS"]},
    ...
    "AFR": {"name": "Air France", "weight": 0.02, "hubs": ["CDG"]},
    "KLM": {"name": "KLM Royal Dutch", "weight": 0.02, "hubs": ["AMS"]},
    "JAL": {"name": "Japan Airlines", "weight": 0.02, "hubs": ["NRT", "HND"]},
    "SIA": {"name": "Singapore Airlines", "weight": 0.02, "hubs": ["SIN"]},
    "QFA": {"name": "Qantas", "weight": 0.02, "hubs": ["SYD", "MEL"]},
    "KAL": {"name": "Korean Air", "weight": 0.02, "hubs": ["ICN"]},
    "THY": {"name": "Turkish Airlines", "weight": 0.02, "hubs": ["IST"]},
    "ETD": {"name": "Etihad Airways", "weight": 0.01, "hubs": ["AUH"]},
    "ACA": {"name": "Air Canada", "weight": 0.02, "hubs": ["YYZ", "YVR"]},
    "AMX": {"name": "Aeromexico", "weight": 0.01, "hubs": ["MEX"]},
    "TAM": {"name": "LATAM Airlines", "weight": 0.02, "hubs": ["GRU", "SCL"]},
    "SAA": {"name": "South African Airways", "weight": 0.01, "hubs": ["JNB"]},
    "EVA": {"name": "EVA Air", "weight": 0.01, "hubs": ["TPE"]},
    "FDB": {"name": "flydubai", "weight": 0.01, "hubs": ["DXB"]},
    "VIR": {"name": "Virgin Atlantic", "weight": 0.01, "hubs": ["LHR"]},
    "RYR": {"name": "Ryanair", "weight": 0.01, "hubs": ["STN", "DUB"]},
    "EZY": {"name": "easyJet", "weight": 0.01, "hubs": ["LGW", "LTN"]},
}
