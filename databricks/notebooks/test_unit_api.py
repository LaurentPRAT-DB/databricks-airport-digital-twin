...
# MAGIC %md
# MAGIC # Unit Tests — API (pytest -m api)
# MAGIC Fast API/TestClient tests (~413 tests). Part of the parallel unit test job.
...
# Run API-marked tests only
result = subprocess.run(
    [
        sys.executable, "-m", "pytest",
        "tests/", "-m", "api", "-q", "--tb=short",
