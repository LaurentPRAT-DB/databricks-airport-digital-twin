...
Before implementing a fix or feature, search `.planning/` for existing analysis:
...
Roadmap: `.planning/ROADMAP.md`. Docs: `docs/SPECIFICATION.md`, `docs/DATA_DICTIONARY.md`, `docs/ML_MODELS.md`.
